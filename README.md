...
### ☁️ [GeoCloud Technologies] (#) *(Founder & Software Engineer)*

> A tech-oriented startup organization dedicated to delivering innovative software solutions and bringing creative ideas to life. Currently scaling our digital footprint and establishing core product offerings.
...
> Led the technical execution and team strategy for the Impakto project as part of a KFW challenge. Managed the full lifecycle from problem space analysis and story mapping to the final technical presentation.
> **Tech Stack:** `Full Stack Development` • `System Architecture`

## 🚀 What I'm Up To

- 💻 **Engineering:** Building engaging, purpose-driven frontend features.
- 🌍 **Building:** Growing **GeoCloud Technologies** and bringing innovative ideas to life.
